...
function AnthropicLogo({ className }: { className?: string }) {
  return <svg className={className} viewBox="0 0 24 24" fill="#D97757"><path d="M17.304 3.541h-3.483l6.196 16.918h3.483L17.304 3.541zm-10.608 0L.5 20.459h3.483l1.272-3.594h6.476l1.272 3.594h3.483L10.29 3.541H6.696zm-.14 10.424L9.49 6.283l2.935 7.682H6.556z"/></svg>;
}
...
function XaiLogo({ className }: { className?: string }) {
  return <svg className={className} viewBox="0 0 24 24" fill="#FFFFFF"><path d="M1.477 0h4.267L12 8.81 18.256 0h4.267L13.846 11.707 23.477 24h-4.267L12 14.373 4.79 24H.523l9.631-12.293L1.477 0z"/></svg>;
}

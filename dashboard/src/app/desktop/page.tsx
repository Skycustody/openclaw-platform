...
/** Windows .exe not published yet — avoid 404; same as release page */
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-5xl px-6 pt-24 pb-16">
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          Requires a Desktop subscription or active trial. Windows installer is not on GitHub yet — Mac DMGs only for now.{' '}
